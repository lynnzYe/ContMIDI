...
from src.util.magenta.interfaces.midi import midi_hub
from src.util.magenta.interfaces.midi import midi_interaction
from src.util.magenta.models.drums_rnn import drums_rnn_sequence_generator
from src.util.magenta.models.melody_rnn import melody_rnn_sequence_generator
from src.util.magenta.models.performance_rnn import performance_sequence_generator
from src.util.magenta.models.pianoroll_rnn_nade import pianoroll_rnn_nade_sequence_generator
from src.util.magenta.models.polyphony_rnn import polyphony_sequence_generator
from src.util.magenta.models.shared import sequence_generator_bundle
import six
