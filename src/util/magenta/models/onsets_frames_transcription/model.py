...
from src.util.magenta.common import flatten_maybe_padded_sequences
from src.util.magenta.common import tf_utils
from src.util.magenta.contrib import cudnn_rnn as contrib_cudnn_rnn
from src.util.magenta.contrib import rnn as contrib_rnn
from src.util.magenta.contrib import training as contrib_training
from src.util.magenta.models.onsets_frames_transcription import constants
from src.util.magenta.models.onsets_frames_transcription import infer_util
from src.util.magenta.models.onsets_frames_transcription import metrics
