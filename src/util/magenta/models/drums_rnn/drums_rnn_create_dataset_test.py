...
from src.util.magenta.models.drums_rnn import drums_rnn_pipeline
from src.util.magenta.models.shared import events_rnn_model
from src.util.magenta.pipelines import drum_pipelines
