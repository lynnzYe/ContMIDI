...
from src.util.magenta.models.score2perf import modalities
from src.util.magenta.models.score2perf import music_encoders
...
def _maestro_input_transform():
  from src.util.magenta.models.score2perf import datagen_beam  # pylint: disable=g-import-not-at-top,import-outside-toplevel
  return dict(
