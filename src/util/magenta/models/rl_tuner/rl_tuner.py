...
from src.util.magenta.models.rl_tuner import note_rnn_loader
from src.util.magenta.models.rl_tuner import rl_tuner_eval_metrics
from src.util.magenta.models.rl_tuner import rl_tuner_ops
  ...
  def __init__(self, output_dir,
    ...
    with self.graph.as_default():
      ...
      if note_rnn_checkpoint_dir is None or not note_rnn_checkpoint_dir:
        print('Retrieving checkpoint of Note RNN from src.util.magenta download server.')
