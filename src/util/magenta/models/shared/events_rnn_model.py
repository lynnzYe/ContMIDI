...
from src.util.magenta.common import beam_search
from src.util.magenta.common import state_util
from src.util.magenta.contrib import training as contrib_training
# from src.util.magenta.models.shared import events_rnn_graph
from src.util.magenta.models.shared import model
import note_seq
import numpy as np
