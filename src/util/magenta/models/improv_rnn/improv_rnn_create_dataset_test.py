...
import src.util.magenta
from src.util.magenta.contrib import training as contrib_training
from src.util.magenta.models.improv_rnn import improv_rnn_model
from src.util.magenta.models.improv_rnn import improv_rnn_pipeline
from src.util.magenta.pipelines import lead_sheet_pipelines
from src.util.magenta.pipelines import note_sequence_pipelines
from src.util.magenta.pipelines import pipelines_common
import note_seq
