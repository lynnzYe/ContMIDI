...
from src.util.magenta.common import Nade
import src.util.magenta.contrib.rnn as contrib_rnn
import src.util.magenta.contrib.seq2seq as contrib_seq2seq
import src.util.magenta.contrib.training as contrib_training
from src.util.magenta.models.music_vae import base_model
from src.util.magenta.models.music_vae import lstm_utils
import numpy as np
