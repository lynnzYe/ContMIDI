...
from src.util.magenta.common import merge_hparams
from src.util.magenta.contrib import training as contrib_training
from src.util.magenta.models.music_vae import data
from src.util.magenta.models.music_vae import data_hierarchical
from src.util.magenta.models.music_vae import lstm_models
from src.util.magenta.models.music_vae.base_model import MusicVAE
import note_seq
