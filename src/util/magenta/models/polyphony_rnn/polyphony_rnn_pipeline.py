...
from src.util.magenta.models.polyphony_rnn import polyphony_lib
from src.util.magenta.pipelines import dag_pipeline
from src.util.magenta.pipelines import event_sequence_pipeline
from src.util.magenta.pipelines import note_sequence_pipelines
from src.util.magenta.pipelines import pipeline
