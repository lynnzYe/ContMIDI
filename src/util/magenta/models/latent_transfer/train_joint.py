...
from src.util.magenta.models.latent_transfer import common
from src.util.magenta.models.latent_transfer import common_joint
from src.util.magenta.models.latent_transfer import model_joint
import numpy as np
import six
